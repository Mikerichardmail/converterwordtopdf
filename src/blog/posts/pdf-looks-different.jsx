...
export default function PdfLooksDifferentPost() {
  return (
    <div className="space-y-6">
      <p className="text-gray-600">
        Fix font discrepancies and layout shifts in PDFs. Having access to local, secure document tools is critical for speed and privacy. In this guide, we break down how to handle this task quickly and efficiently.
      </p>
      ...
      <ol className="list-decimal list-inside space-y-2 text-gray-600 pl-2">
        <li>Verify if the PDF has embedded fonts or relies on local operating system fonts.</li>
        <li>Non-standard fonts will be substituted by the reader app if they are not embedded.</li>
        <li>Always export documents with "embed all fonts" options selected.</li>
      </ol>
      ...
      <div className="space-y-4">
        <div>
          <h3 className="font-bold text-gray-800 text-sm">How do I check if fonts are embedded?</h3>
          <p className="text-gray-500 text-xs mt-1">Open the PDF in Adobe Reader, press Ctrl+D, and check the Fonts tab.</p>
        </div>
        <div>
          <h3 className="font-bold text-gray-800 text-sm">Will converting it fix the issue?</h3>
          <p className="text-gray-500 text-xs mt-1">Converting a Word document to PDF using our web tool embeds standard typography automatically.</p>
        </div>
      </div>

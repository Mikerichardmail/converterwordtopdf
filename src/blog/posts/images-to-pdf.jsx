...
export default function ImagesToPdfPost() {
  return (
    <div className="space-y-6">
      <p className="text-gray-600">
        Merge several JPG, PNG, or WebP images into a single PDF. Having access to local, secure document tools is critical for speed and privacy. In this guide, we break down how to handle this task quickly and efficiently.
      </p>
      ...
      <ol className="list-decimal list-inside space-y-2 text-gray-600 pl-2">
        <li>Open the Images to PDF page.</li>
        <li>Select all the images (JPG, PNG, WebP) you want to compile.</li>
        <li>Arrange the files in order.</li>
        <li>Convert and download the unified PDF document.</li>
      </ol>
      ...
      <div className="space-y-4">
        <div>
          <h3 className="font-bold text-gray-800 text-sm">What image formats are supported?</h3>
          <p className="text-gray-500 text-xs mt-1">We support JPG, PNG, GIF, WebP, and BMP images.</p>
        </div>
        <div>
          <h3 className="font-bold text-gray-800 text-sm">Will my image resolution be decreased?</h3>
          <p className="text-gray-500 text-xs mt-1">No, images are embedded in their full resolution to maintain document quality.</p>
        </div>
      </div>

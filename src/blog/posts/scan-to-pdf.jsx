  ...
  return (
    <div className="space-y-6">
      <p className="text-gray-600">
        Scan paper documents directly to PDF with mobile devices. Having access to local, secure document tools is critical for speed and privacy. In this guide, we break down how to handle this task quickly and efficiently.
      </p>
      ...
      <ol className="list-decimal list-inside space-y-2 text-gray-600 pl-2">
        <li>Use your phone camera to take clear photos of your document.</li>
        <li>Go to the Images to PDF tool on your phone browser.</li>
        <li>Upload the captured images in order.</li>
        <li>Press Convert to save them as a clean scan PDF.</li>
      </ol>
      ...
      <div className="space-y-4">
        <div>
          <h3 className="font-bold text-gray-800 text-sm">How do I ensure the scan is readable?</h3>
          <p className="text-gray-500 text-xs mt-1">Capture photos under good, direct lighting and avoid casting hand shadows.</p>
        </div>
        <div>
          <h3 className="font-bold text-gray-800 text-sm">Does the scanner align pages automatically?</h3>
          <p className="text-gray-500 text-xs mt-1">The browser layout engine embeds images cleanly on standard A4 layout boundaries.</p>
        </div>
      </div>

      <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">Conclusion</h2>
      <p className="text-gray-600">
        Managing your documents efficiently shouldn't mean sacrificing data privacy. Use the local tools on <Link to="/images-to-pdf" className="text-brand-500 hover:underline font-semibold">converterwordtopdf.com</Link> or install the desktop extension for offline ease.
      </p>
    </div>
  )
}

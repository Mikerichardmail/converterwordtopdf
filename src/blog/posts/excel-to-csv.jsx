...
export default function ExcelToCsvPost() {
  return (
    <div className="space-y-6">
      <p className="text-gray-600">
        Export Excel tables to CSV files cleanly. Having access to local, secure document tools is critical for speed and privacy. In this guide, we break down how to handle this task quickly and efficiently.
      </p>
      ...
      <ol className="list-decimal list-inside space-y-2 text-gray-600 pl-2">
        <li>Select the Excel spreadsheet file.</li>
        <li>Choose the sheet index you want to export.</li>
        <li>Process with our local CSV exporter.</li>
        <li>Download your comma-delimited text document.</li>
      </ol>
      ...
      <div className="space-y-4">
        <div>
          <h3 className="font-bold text-gray-800 text-sm">Can I export multi-sheet files to a single CSV?</h3>
          <p className="text-gray-500 text-xs mt-1">CSV only supports a single flat sheet. You must export each sheet tab separately.</p>
        </div>
        <div>
          <h3 className="font-bold text-gray-800 text-sm">How is UTF-8 text handled?</h3>
          <p className="text-gray-500 text-xs mt-1">We export cleanly using UTF-8 formatting to preserve foreign characters and symbols.</p>
        </div>
      </div>

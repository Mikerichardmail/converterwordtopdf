...
export default function ExtractPdfPagePost() {
  return (
    <div className="space-y-6">
      <p className="text-gray-600">
        Quickly save a single page of your PDF as a separate file. Having access to local, secure document tools is critical for speed and privacy. In this guide, we break down how to handle this task quickly and efficiently.
      </p>
      ...
      <ol className="list-decimal list-inside space-y-2 text-gray-600 pl-2">
        <li>Upload your PDF to the Split PDF page.</li>
        <li>Enter the single page number you wish to extract (e.g., 4).</li>
        <li>Click Split and download the document containing only that page.</li>
      </ol>
      ...
      <div className="space-y-4">
        <div>
          <h3 className="font-bold text-gray-800 text-sm">Do I have to pay for Adobe for this task?</h3>
          <p className="text-gray-500 text-xs mt-1">No, extracting pages is completely free and handled locally in your browser.</p>
        </div>
        <div>
          <h3 className="font-bold text-gray-800 text-sm">Can I extract multiple non-consecutive pages?</h3>
          <p className="text-gray-500 text-xs mt-1">Yes, separate them by commas (e.g., 1, 4, 7) to extract those specific pages.</p>
        </div>
      </div>

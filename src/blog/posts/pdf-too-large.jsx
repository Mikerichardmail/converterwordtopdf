...
export default function PdfTooLargePost() {
  return (
    <div className="space-y-6">
      <p className="text-gray-600">
        Understand why PDFs get large and how to optimize them. Having access to local, secure document tools is critical for speed and privacy. In this guide, we break down how to handle this task quickly and efficiently.
      </p>
      ...
      <ol className="list-decimal list-inside space-y-2 text-gray-600 pl-2">
        <li>Open the Compress PDF tool page.</li>
        <li>Import your bloated PDF file.</li>
        <li>Run the client-side optimization algorithm.</li>
        <li>Save the optimized PDF.</li>
      </ol>
      ...
      <div className="space-y-4">
        <div>
          <h3 className="font-bold text-gray-800 text-sm">Why do PDFs get so large?</h3>
          <p className="text-gray-500 text-xs mt-1">High-res images, embedded custom font families, and unoptimized vector graphics are the primary causes.</p>
        </div>
        <div>
          <h3 className="font-bold text-gray-800 text-sm">How can I fix it?</h3>
          <p className="text-gray-500 text-xs mt-1">Compressing the PDF replaces high-resolution imagery with web-friendly resolutions and removes duplicate assets.</p>
        </div>
      </div>

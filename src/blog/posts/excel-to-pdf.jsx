...
export default function ExcelToPdfPost() {
  return (
    <div className="space-y-6">
      <p className="text-gray-600">
        Transform spreadsheets to printable PDF format easily. Having access to local, secure document tools is critical for speed and privacy. In this guide, we break down how to handle this task quickly and efficiently.
      </p>
      ...
      <ol className="list-decimal list-inside space-y-2 text-gray-600 pl-2">
        <li>Save your spreadsheet table as CSV or OpenDocument.</li>
        <li>Drag and drop the sheet into our browser conversion platform.</li>
        <li>Compile and save the formatted PDF document.</li>
      </ol>
      ...
      <div className="space-y-4">
        <div>
          <h3 className="font-bold text-gray-800 text-sm">Will the gridlines be visible?</h3>
          <p className="text-gray-500 text-xs mt-1">Gridlines will show depending on your original page export settings.</p>
        </div>
        <div>
          <h3 className="font-bold text-gray-800 text-sm">How do I handle wide spreadsheets?</h3>
          <p className="text-gray-500 text-xs mt-1">Configure the print options to Landscape orientation before exporting to keep columns from splitting.</p>
        </div>
      </div>

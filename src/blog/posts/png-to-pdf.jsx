...
export default function PngToPdfPost() {
  return (
    <div className="space-y-6">
      <p className="text-gray-600">
        Convert PNG images into clean PDF documents on the fly. Having access to local, secure document tools is critical for speed and privacy. In this guide, we break down how to handle this task quickly and efficiently.
      </p>
      ...
      <ol className="list-decimal list-inside space-y-2 text-gray-600 pl-2">
        <li>Visit the Images to PDF converter page.</li>
        <li>Drag your PNG image files into the tool container.</li>
        <li>Click the Convert button.</li>
        <li>Save the PDF to your system.</li>
      </ol>
      ...
      <div className="space-y-4">
        <div>
          <h3 className="font-bold text-gray-800 text-sm">Will the background remain transparent?</h3>
          <p className="text-gray-500 text-xs mt-1">No, PDF does not support transparency in the same way. Transparent areas will render as white pages.</p>
        </div>
        <div>
          <h3 className="font-bold text-gray-800 text-sm">Can I select multiple files?</h3>
          <p className="text-gray-500 text-xs mt-1">Yes, you can upload and arrange multiple files simultaneously.</p>
        </div>
      </div>

...
export default function PdfTextNotSelectablePost() {
  return (
    <div className="space-y-6">
      <p className="text-gray-600">
        Fix non-selectable text issues on scanned PDF documents. Having access to local, secure document tools is critical for speed and privacy. In this guide, we break down how to handle this task quickly and efficiently.
      </p>
      ...
      <ol className="list-decimal list-inside space-y-2 text-gray-600 pl-2">
        <li>Determine if the PDF page is a flat photo scan or vector file.</li>
        <li>Flat scans contain image pixels instead of digital characters.</li>
        <li>Run the PDF through an OCR program or convert it to DOCX to extract texts.</li>
      </ol>
      ...
      <div className="space-y-4">
        <div>
          <h3 className="font-bold text-gray-800 text-sm">How do I know if text is selectable?</h3>
          <p className="text-gray-500 text-xs mt-1">Try highlighting a line of text. If the entire page turns blue or nothing highlights, it is a flat image scan.</p>
        </div>
        <div>
          <h3 className="font-bold text-gray-800 text-sm">Does our converter support OCR?</h3>
          <p className="text-gray-500 text-xs mt-1">Our converter extracts text elements. For image scans, using the desktop extension is recommended.</p>
        </div>
      </div>

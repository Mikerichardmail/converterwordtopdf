...
export default function ReducePdfSizeEmailPost() {
  return (
    <div className="space-y-6">
      <p className="text-gray-600">
        Shrink PDF document size to bypass email attachment limits. Having access to local, secure document tools is critical for speed and privacy. In this guide, we break down how to handle this task quickly and efficiently.
      </p>
      ...
      <ol className="list-decimal list-inside space-y-2 text-gray-600 pl-2">
        <li>Load your file onto the Compress PDF tool.</li>
        <li>Let the optimizer remove redundant structures.</li>
        <li>Download the reduced PDF file.</li>
        <li>Attach it to your email safely.</li>
      </ol>
      ...
      <div className="space-y-4">
        <div>
          <h3 className="font-bold text-gray-800 text-sm">What is the limit for email attachments?</h3>
          <p className="text-gray-500 text-xs mt-1">Most services like Gmail and Outlook cap attachments at 20MB to 25MB.</p>
        </div>
        <div>
          <h3 className="font-bold text-gray-800 text-sm">Does size reduction alter the text?</h3>
          <p className="text-gray-500 text-xs mt-1">No, text remains fully searchable and editable.</p>
        </div>
      </div>

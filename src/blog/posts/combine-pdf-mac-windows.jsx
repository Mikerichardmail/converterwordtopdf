...
export default function CombinePdfMacWindowsPost() {
  return (
    <div className="space-y-6">
      <p className="text-gray-600">
        Cross-platform guide to merge multiple PDF files safely. Having access to local, secure document tools is critical for speed and privacy. In this guide, we break down how to handle this task quickly and efficiently.
      </p>
      ...
      <ol className="list-decimal list-inside space-y-2 text-gray-600 pl-2">
        <li>Open the Merge PDF Page in your web browser.</li>
        <li>Add all PDF files you want to combine.</li>
        <li>Rearrange the order of the files if necessary.</li>
        <li>Click Merge PDF and save the unified document.</li>
      </ol>
      ...
      <div className="space-y-4">
        <div>
          <h3 className="font-bold text-gray-800 text-sm">Does this tool work on Linux?</h3>
          <p className="text-gray-500 text-xs mt-1">Yes! Since it runs inside the web browser, it is fully compatible with Windows, macOS, Linux, and ChromeOS.</p>
        </div>
        <div>
          <h3 className="font-bold text-gray-800 text-sm">Is there a file limit?</h3>
          <p className="text-gray-500 text-xs mt-1">You can merge up to 3 files together per session under the free daily limit.</p>
        </div>
      </div>
